...
class RemainingMacros {
  ...
  String get cacheKey {
    ...
    return '$rCal|$rP|$rC|$rF';
  }

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is RemainingMacros && runtimeType == other.runtimeType && cacheKey == other.cacheKey;
...
final dailyInsightProvider =
  ...
  final prompt = StringBuffer()
    ...
    ..writeln('The user has the following macros remaining for today:')
  ...
  try {
    ...
    if (cal <= 0) {
      return 'You have hit your calorie goal for today. Consider herbal tea or sparkling water if you feel hungry.';
    }
    if (p > 0 && p <= c && p <= f) {
